...
/*a) VIEW_A que, para cada local de vacinação e por mês, mostre o número de vacinas administradas, o número de pessoas vacinadas (com 1 ou mais tomas) e o número de pessoas com a vacinação completa (que tomaram o número de tomas especificadas para essa vacina). Ordene o resultado pelo local de vacina e descendentemente pelo mês.
*/
...
--Mostra a vacina e quantas reações essa vacina tem
...
-- esta vista apenas ve quantas pessoas são doentes por idade, é bastante simples mas pode ser útil
...
--Esta vista mostra quais vacinas com mais de duas doses têm o tempo de intervalo entre a toma das doses abaixo da média, para aém disto mostra o total de frascos transportados de todas as vacinas.
...
--VISTA_J_a2017015954
--Vista para ver quantas seringas são usadas por dia
...
--VISTA_k_a2017015954
--Verifica que enfermeiro tem um tempo médio de vacinação a baixo da média.
